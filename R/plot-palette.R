...
.palettes <- list(
  ...
  royal4 = c("#899DA4", "#C93312", "#FAEFD1", "#DC863B"),
  asteroid5 = c("#FBA72A", "#D3D4D8", "#CB7A5C", "#5785C1"),
  darjeeling5 = c("#ECCBAE", "#046C9A", "#D69C4E", "#ABDDDE", "#000000"),
  zissou5 = c("#3B9AB2", "#78B7C5", "#EBCC2A", "#E1AF00", "#F21A00"),
  kelly20 = c(
  ...
  blackpink6 = c("#000000", "#EE8D46", "#B03270", "#C0C0C0", "#F5C383", "#D798B7"),
  vega10 = c(
